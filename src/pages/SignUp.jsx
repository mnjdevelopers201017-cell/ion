...
export default function SignUp({ setPage }) {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await signUp.attemptFirstFactor({
        strategy: "email_code",
        code: "verification_code_placeholder", // In a real app, you'd have another input for the code
      });
      
      // For simplicity in this prototype, if the user reaches here, we assume they are creating the account.
      // Note: Normally you'd handle the verification code step.
      setPage("dashboard");
    } catch (err) {
    ...
    <div className="flex min-h-screen items-center justify-center bg-[#050816] text-white p-4">
      ...
      >
        <div className="text-center space-y-2">
          ...
          <p className="text-slate-400">Join the futuristic world of Ion</p>
        </div>
