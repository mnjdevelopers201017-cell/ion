  ...
  const cards = [
    {
      ...
      description:
        "Generate aesthetic AI images with emotional captions and cinematic vibes.",
      glow: "cyan",
    },
    {
      title: "Create Animations with Ion",
      description:
        "Bring ideas to life with futuristic AI animations and emotional scenes.",
      glow: "purple",
    },
    {
      title: "Quirks & Notifications from Ion",
      description:
        "Receive emotional updates, reminders, alerts, and futuristic AI notifications.",
      glow: "pink",
    },
  ];
      ...
      <div className="relative z-10 mt-16 grid gap-8 px-6 pb-20 md:grid-cols-3">
        ...
        {cards.map((card, index) => (
          ...
          >
           ...
           <a
  href={
    card.title === "Quirks & Notifications from Ion"
      ? "/ion-chat"
      : "#"
  }
>
